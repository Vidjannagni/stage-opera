...
\glossaire{Vocabulaire métier}{%
			...
			\hline
			\rowcolor{gray!8}
			Standing & Niveau de gamme d'un bien. Le cabinet en cite cinq
			(économique, social, moyen standing, haut standing, luxe) ; l'outil
			n'en retient que trois, les deux extrêmes ne se plaidant que par
			rapport aux autres. \\
			\hline
			\rowcolor{white}
...
{Brief de recherche : les critères recueillis au premier entretien. Ce formulaire
	n'existait pas avant l'entretien de cadrage. Les questions posées suivent le
	type de bien --- un terrain n'a ni standing ni distribution, mais une
	viabilisation et un zonage.}{}
